...
pub(super) struct ApprovalDetails<'a> {
    pub(super) outer_message: &'a VersionedMessage,
    pub(super) inner_message: legacy::Message,
    pub(super) nonce_account: Address,
}
...
pub(super) fn validate_approval_message(
    outer_message: &VersionedMessage,
) -> Result<ApprovalDetails<'_>> {
